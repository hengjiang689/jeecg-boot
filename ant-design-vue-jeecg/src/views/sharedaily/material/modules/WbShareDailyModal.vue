    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="图片" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-textarea v-decorator="['images']" rows="4" placeholder="请输入图片"/>
        </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'content','likeNum','images'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'content','courseId','type','likeNum','images'))
      },
